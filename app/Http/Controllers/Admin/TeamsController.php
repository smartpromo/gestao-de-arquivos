...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $convenios = \App\Convenio::where('created_by_team_id', $id)->get();$users = \App\User::where('team_id', $id)->get();$medicos = \App\Medico::where('created_by_team_id', $id)->get();$guias = \App\Guia::where('created_by_team_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'convenios', 'users', 'medicos', 'guias'));
    }
