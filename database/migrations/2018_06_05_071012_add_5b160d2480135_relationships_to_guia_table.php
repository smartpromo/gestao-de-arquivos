...
class Add5b160d2480135RelationshipsToGuiaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('guias', function(Blueprint $table) {
            if (!Schema::hasColumn('guias', 'medico_id')) {
                ...
                $table->foreign('relatorios_id', '164555_5b160d2033563')->references('id')->on('medicos')->onDelete('cascade');
                }
